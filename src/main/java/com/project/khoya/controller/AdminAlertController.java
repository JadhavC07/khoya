...
public class AdminAlertController {
    ...
    @Operation(
            ...
            description = "Get comprehensive statistics about alerts",
    ...
    @Operation(
            summary = "Get alerts with high report count",
            description = "Get alerts that have been reported multiple times for admin review",
            security = @SecurityRequirement(name = "bearerAuth")
    )
    public ResponseEntity<Map<String, Object>> getHighReportAlerts(
    ...
    @Operation(
            ...
            description = "Update the status of any alert (admin only)",
            security = @SecurityRequirement(name = "bearerAuth")
    )
    public ResponseEntity<AlertResponse> updateAlertStatus(
        ...
        return ResponseEntity.ok(AlertResponse.builder()
                .id(savedAlert.getId())
                ...
                .reportCount(savedAlert.getReportCount())
                .createdAt(savedAlert.getCreatedAt())
                .updatedAt(savedAlert.getUpdatedAt())
                .foundAt(savedAlert.getFoundAt())
                .postedBy(AlertResponse.UserInfo.builder()
                        .id(savedAlert.getPostedBy().getId())
                        .name(savedAlert.getPostedBy().getName())
                        .email(savedAlert.getPostedBy().getEmail())
                        .build())
                .build());
    }
}
