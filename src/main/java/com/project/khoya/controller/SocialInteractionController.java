...
//            description = "Add a comment or reply to an alert",
...
//            description = "Get all comments for an alert with optional sorting"
//    )
//    @ApiResponse(
//            responseCode = "200",
//            description = "Comments retrieved successfully"
//    )
//    public ResponseEntity<List<CommentResponse>> getAlertComments(
//            @Parameter(description = "Alert ID", required = true)
//            @PathVariable Long alertId,
//
//            @Parameter(description = "Sort by: recent, score", example = "recent")
...
//            description = "Upvote or downvote an alert",
//            security = @SecurityRequirement(name = "bearerAuth")
//    )
//    @PreAuthorize("hasRole('USER') or hasRole('ADMIN')")
//    public ResponseEntity<Map<String, Object>> voteOnAlert(
//            @Parameter(description = "Alert ID", required = true)
//            @PathVariable Long alertId,
...
//            description = "Get vote statistics for a comment"
//    )
